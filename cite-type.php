...
<img src="img/book.jpg" class="img-fluid header-img">
    ...
    <main role="main" class="container content" id="main">
      ...
      <section class="container" id="cite-type">
		...
		<div class="col-6">
		<a href="cite-input.php?type=book" class="btn btn-primary">Book</a>
		<a href="cite-input.php?type=journal" class="btn btn-primary">journal</a>
		<a href="cite-input.php?type=article" class="btn btn-primary">article</a>
		</div>
		</div>
		</section>
